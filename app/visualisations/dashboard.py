                ...
                [
                    dcc.Textarea
                        (
                            ...
                            value='This plan must be prepared in consultation with NOW and OEH by a suitably qualified expert whose appointment has been endorsed bythe DirectorGeneral and submitted to the DirectorGeneral for approval by the end of June  lnaddition to the standard requirements for management plans see condition 2 of schedule 7 this planmusta include a comprehensive water balance for the project andb ensure that suitable measures are implemented to minimise water use control erosion preventgroundwater contamination and comply with any surface water discharge limits.',
...
card_header = dbc.Card(
    dbc.CardBody(
        [
            html.H1(children='Enforceability Classifier/Predictor',
                style={
                        'textAlign': 'centre',
#                        'background': 'grey',
