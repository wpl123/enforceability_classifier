...
app = dash.Dash(__name__,
    ...
    # search engines when displaying search results.
    {
        ...
        'content': 'Sentiment Analysis of NSW Planning Conditons for coal mines based on the degree of compulsion or discretion in the conditions terms'
    },
    ...
    dbc.CardBody(
        [
            html.Div(
                ...
                children=[
                    html.Div('Enforceability Classifier/Predictor', className="app-header--title")
                    ],
#                style={
#                        'textAlign': 'centre',
##                        'background': 'grey',
                ...
                dbc.Row(children=[
                    dbc.Col(
                        children=[
                             ...
                             ], width={"size": 4, "order": 1}, align="start",
                    ),
                    dbc.Col(
                           [
                               dbc.Card(card_graph1)
                           ], width={"size": 8, "order": 2}, align="end",
                    ),
